...
\newcommand{\actividadBB}{
  \begin{minipage}[H]{1.0\linewidth}
   \fbox{Actividad B2:} Uno de los 5 estudiantes de cada grupo, creará un repositorio llamado B2, cada integrante creará un subdirectorio con el nombre ``ApellidoNombre'', dentro de este se cargará la solución a 7 problemas propuestos en la unidad 9(diagrama de flujo y programa en C++). 
  \end{minipage}
  }
...
\newcommand{\actividadCB}{
  \begin{minipage}[H]{1.0\linewidth}
   \fbox{Actividad C2:} Creando un repositorio C2 con el mismo procedimiento de la actividad B2, cada estudiante transcribirá el programa en C++ a mano y los subirá al repositorio con las mejoras respectivas.
  \end{minipage}
  }
...
\begin{longtable}[H]{|b{0.5cm}|b{0.5cm}|b{0.5cm}|b{0.5cm}|b{0.5cm}|b{0.5cm}|b{10cm}|b{10cm}|}
\cabecera
\multirow{3}{*}[-10ex]{\rotatebox{90}{CUARTA SEMANA}}  & \multirow{3}{*}[-10ex]{\rotatebox[origin=c]{90}{28-febrero-2022}}& \multirow{3}{*}[-10ex]{\rotatebox{90}{04-marzo-2022}} & 2& &C&  \multicolumn{2}{c|}{\semanaDA} \\ \cline{4-8} 
...
\headwidth=\textwidth
\linewidth= 240mm
\begin{longtable}{|b{4cm}@{\hspace{0.4cm}}|m{2.3cm}|m{\linewidth-6cm}|}
